...
'(1 '(2 '(3 4 5)))
; expect (1 quote(2 quote(3 4 5)))

;;; Q7 
(begin (/ 5 1) (+ 10 5) (begin 15))
; expect 15

;;; Q8
(lambda (a b c) (1 10 100))
; expect (lambda (a b c) (1 10 100))

(lambda (a b c) (1 10 (lambda (x y z) (2 4 8))))
; expect (lambda (a b c) (1 10 (lambda (x y z) (2 4 8))))

;;; Q9A
(define (f x y z) (+ x y z))
; expect f

(begin (define (f x) (+ x 2)) (f 2))
; expect 4
...
;;; Q17
(begin (define g (mu (w v) (+ w v))) (g 2 3)
) 
; expect 5
